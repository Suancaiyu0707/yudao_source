...
全部实体在 [Github 优惠劵(码）实体目录](todo) 下可见。

## 3.1 CouponGroup

[CouponGroup](todo) ，优惠劵（码）组。优惠劵和优惠劵的配置，都存储在 CouponGroup 中。
...
[CouponVerifyLog](todo) ，优惠券（码）核销记录。
