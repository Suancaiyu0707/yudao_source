...
* `type = rich_text` 。
* [](../../../images/Entity/2018_01_23/18.png)
...
* `type = cube2` 。
* 可以在魔方中添加指定大小的**方块** [](../../../images/Entity/2018_01_23/19.png)
...
* `type = text_nav` 。
* [](../../../images/Entity/2018_01_23/20.png)
...
* `type = nav` 。
* [](../../../images/Entity/2018_01_23/21.png)
...
* `type = nav` 。
* [](../../../images/Entity/2018_01_23/35.png)
...
* 该元素有两种模板样式，根据 `titleTemplate` 判断样式：
    * 传统样式，使用 `title`、`subTitle`、`showMethod`、`color`、`subEntrys` 等字段。  [](../../../images/Entity/2018_01_23/22.png)
    * 模仿微信图文页样式，使用 `title`、`wx_` 前缀等字段们。  [](../../../images/Entity/2018_01_23/23.png)
...
* 该元素有两种模板样式，根据 `style` 判断样式：
    * 模仿微信对话样式  [](../../../images/Entity/2018_01_23/24.png)
    * 简易音乐播放器  [](../../../images/Entity/2018_01_23/25.png)
...
* `type = notice` 。
* [](../../../images/Entity/2018_01_23/26.png)
...
* `type = line` 。
* [](../../../images/Entity/2018_01_23/27.png)
...
* `type = white` 。
* [](../../../images/Entity/2018_01_23/28.png)

### 3.3.12 ItemTemplateStoreElementVO

[ItemTemplateStoreElementVO](todo) ，进入店铺元素 VO 。
...
* `type = store` 。
* [](../../../images/Entity/2018_01_23/29.png)


### 3.3.13 ItemTemplateSearchElementVO

[ItemTemplateSearchElementVO](todo) ，搜索商品元素 VO 。
...
* `type = search` 。
* [](../../../images/Entity/2018_01_23/30.png)
...
* 该元素有四种**列表**样式，根据 `size` 判断样式：
    * 大图  [](../../../images/Entity/2018_01_23/31.png)
    * 小图  [](../../../images/Entity/2018_01_23/32.png)
    * 一大两小  [](../../../images/Entity/2018_01_23/33.png)
    * 详细列表  [](../../../images/Entity/2018_01_23/34.png)
...
* `type = goods` 。
* 整体字段类似 [ItemTemplateGoodsElementVO](https://github.com/YunaiV/doraemon-entity/blob/5b1352b12d56f957743fbda1291f000e264b53f9/src/main/java/cn/iocoder/doraemon/itemgroup/item/entity/vo/ItemTemplateCubeElementVO.java) 。  [](../../../images/Entity/2018_01_23/36.png)
...
[ItemTemplateGoodsTagListElementVO](todo) ，商品分组元素 VO 的**第一种**。
...
* `type = tag_list` 。
* [](../../../images/Entity/2018_01_23/37.png)
...
* `type = tags` 。
* 整体字段类似 [ItemTemplateGoodsListElementVO](https://github.com/YunaiV/doraemon-entity/blob/5b1352b12d56f957743fbda1291f000e264b53f9/src/main/java/cn/iocoder/doraemon/itemgroup/item/entity/vo/ItemTemplateGoodsTagListElementVO.java) 。[](../../../images/Entity/2018_01_23/38.png)
...
[ItemTemplateLinkElementVO](todo) ，关联链接元素 VO 的。
...
* `type = link` 。
* [](../../../images/Entity/2018_01_23/39.png)
* `subEntrys` ，TODO 冗余不会更新

### 3.3.18 ItemTemplateComponentElementVO

[ItemTemplateComponentElementVO](todo) ，自定义模块元素 VO 。
...
* `type = component` 。
* [](../../../images/Entity/2018_01_23/40.png)
