...
[ItemTemplateImageNavElementVO](todo) ，图片导航元素 VO 。
...
* `subEntrys` ，[SelectionElementVO](todo) 数组，JSON 格式化成字符串。

### 3.3.6 ItemTemplateShowCaseElementVO

[ItemTemplateShowCaseElementVO](todo) ，橱窗元素 VO 。
...
[ItemTemplateGoodsElementVO](todo) ，商品元素 VO 。
...
[ItemTemplateGoodsListElementVO](todo) ，商品列表元素 VO 。
...
* `type = goods` 。
* 整体字段类似 [ItemTemplateGoodsElementVO](todo) 。  [](../../../images/Entity/2018_01_23/36.png)
* `goods` ，TODO 冗余不会更新
...
[ItemTemplateGoodsTagsElementVO](todo) ，商品分组元素 VO 的**第二种**。
...
* `type = tags` 。
* 整体字段类似 [ItemTemplateGoodsListElementVO](todo) 。[](../../../images/Entity/2018_01_23/38.png)
* `goods` ，TODO 冗余不会更新
