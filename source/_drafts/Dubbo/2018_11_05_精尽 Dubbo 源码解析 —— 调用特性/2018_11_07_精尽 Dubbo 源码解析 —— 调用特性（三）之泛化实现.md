title: 精尽 Dubbo 源码分析 —— 调用特性（二）之泛化实现
date: 2018-11-07
tags:
categories: Dubbo
...
在 [`dubbo-generic-service-demo-provider`](TODO) ，我们提供了例子。我们挑**重点**的地方说。
...
在 [`dubbo-generic-service-demo-consumer`](TODO) ，我们提供了例子。我们挑**重点**的地方说。
