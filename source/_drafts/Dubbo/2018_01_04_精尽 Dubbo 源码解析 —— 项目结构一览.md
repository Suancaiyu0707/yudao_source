...
[项目结构](../../../images/Dubbo/2018_01_04/01.png)
...
[Statistic 统计代码量](../../../images/Dubbo/2018_01_04/02.png)
...
[Shell 脚本统计代码量](../../../images/Dubbo/2018_01_04/03.png)

# 3. 项目一览

如果胖友看过 [《Dubbo 框架设计》](https://dubbo.gitbooks.io/dubbo-dev-book/design.html) ，就会发现有下面这张图。

> [模块分包](../../../images/Dubbo/2018_01_04/04.png)
...
[dubbo-common 包结构](../../../images/Dubbo/2018_01_04/05.png)
...
[dubbo-remoting 包结构](../../../images/Dubbo/2018_01_04/06.png)
...
[dubbo-rpc 包结构](../../../images/Dubbo/2018_01_04/07.png)
...
[dubbo-cluster 包结构](../../../images/Dubbo/2018_01_04/08.png)
...
> [集群容错](../../../images/Dubbo/2018_01_04/09.png)
...
[dubbo-registry 包结构](../../../images/Dubbo/2018_01_04/10.png)
...
[dubbo-monitor 包结构](../../../images/Dubbo/2018_01_04/11.png)
...
[dubbo-config 包结构](../../../images/Dubbo/2018_01_04/12.png)
...
[dubbo-container 包结构](../../../images/Dubbo/2018_01_04/13.png)
...
[dubbo-filter 包结构](../../../images/Dubbo/2018_01_04/14.png)
...
[dubbo-plugin 包结构](../../../images/Dubbo/2018_01_04/15.png)
...
参见 [《Dubbo 用户指南 —— 快速启动》](http://dubbo.io/books/dubbo-user-book/quick-start.html) 文档。

## 3.13 dubbo-test

[`dubbo-test`](https://github.com/alibaba/dubbo/tree/4bbc0ddddacc915ddc8ff292dd28745bbc0031fd/dubbo-test) **测试模块**。

[dubbo-test 包结构](../../../images/Dubbo/2018_01_04/16.png)
...
[dubbo-dependencies-bom 文件](../../../images/Dubbo/2018_01_04/17.png)

-------

`dubbo-parent` 会引入该 BOM ：

[引入 dubbo-dependencies-bom 文件](../../../images/Dubbo/2018_01_04/18.png)
...
[dubbo-bom 文件](../../../images/Dubbo/2018_01_04/19.png)

-------

`dubbo-demo` 和 `dubbo-test` 会引入该 BOM 。以 `dubbo-demo` 举例子：

[引入 dubbo-bom 文件](../../../images/Dubbo/2018_01_04/20.png)
...
[引入 dubbo-parent 文件](../../../images/Dubbo/2018_01_04/21.png)

-------

我们整理下上面的 pom 文件：

[引入关系](../../../images/Dubbo/2018_01_04/22.png)
