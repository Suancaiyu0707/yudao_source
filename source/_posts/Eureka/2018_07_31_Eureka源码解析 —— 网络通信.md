...
[](../../../images/Eureka/2018_07_31/01.png)
...
[](../../../images/Eureka/2018_07_31/02.png)
...
* 重写了 `#sendHeartBeat(...)` 方法，在 [TODO[0021]：集群同步]() 详细解析。
* 实现 `com.netflix.eureka.cluster.HttpReplicationClient` 接口，实现了 `#submitBatchUpdates(...)` 方法，在 [TODO[0021]：集群同步]() 详细解析。
...
[](../../../images/Eureka/2018_07_31/03.jpeg)
