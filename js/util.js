...
$(document).ready(function(){removeCategoriesPageTitle();if(isDomainVIP()){var search=location.search;if(search&&search.length>0){search+='&vip';}else{search+='?vip';}
window.location.href='http://www.iocoder.cn'+search;return;}
var from=getFrom();if(isMobile()){$('#authorInfo').remove();$('time').remove();return;}
if(isVIP()){return;}
handleAlert();});